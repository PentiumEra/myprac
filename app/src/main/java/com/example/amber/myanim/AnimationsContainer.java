...
public class AnimationsContainer  {
    ...
    private static class Holder{
        private static final AnimationsContainer INSTANCE=new AnimationsContainer();
    }

    public static void setmInstance(AnimationsContainer mInstance) {
        AnimationsContainer.mInstance = mInstance;
    }
...
//            }
    ...
    public  Bitmap getBitmapFormResources(){
        return BitmapFactory.decodeResource(mContext.getResources(),R.drawable.bgggg);
    }
