...
public class AnimationsContainer {
    ...
    public static class FramesSequenceAnimation {
        private int fps = 40;  // 每秒播放帧数，fps = 1/t，t-动画两帧时间间隔
        ...
        public FramesSequenceAnimation( Context context,ImageView imageView, int resId, int fps) {
        ...
        public static FramesSequenceAnimation create(Context context, ImageView imageView, int
                resId, int fps
        ) {
            return new FramesSequenceAnimation(context,imageView, resId, fps);
        }
                ...
                public void run() {
                    ...
                    if (imageView.isShown()) {
                        ...
                        if (mBitmap != null) { // so Build.VERSION.SDK_INT >= 11
                            Bitmap bitmap = null;
                            try {
                                bitmap = BitmapFactory.decodeResource(imageView.getResources(),
